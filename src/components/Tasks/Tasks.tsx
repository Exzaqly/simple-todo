...
import {Dispatch, setFilterValue, setSortingValue, ShowFilterType, SortingType} from "../../redux/filterReducer";
...
export const Tasks: FC = () => {
    ...
    return (
        <div>
            <Sorts showHandleChange={filterHandleChange} sortingHandleChange={sortingHandleChange}/>
            <div>
