...
//по мне так два раза делаешь одно и то же. Если в приложении запланировано добавление в локал сторэдж,
//то добавляй либо сразу, либо в функцию хэндлэр после диспатча.
